        ...
        if self.async_ or self.quiet:
            if self.package:
                ...
                def handleError(exception):
                    ...
                    self.async_(self.package, exception, None)
                ...
                def handlePackages(packages):
                    if self.quiet:
                        ...
                        def handleResult(package):
                            def handler(*result):
                                return self.async_(package, None, result)
                            return handler
                        def handleError(package):
                            def handler(exception):
                                return self.async_(package, exception, None)
                            return handler
